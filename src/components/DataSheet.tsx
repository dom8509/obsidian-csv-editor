...
export default class DataSheet extends React.Component {
	...
	// 			this.handleMouseDownColumnHeader.bind(this);
	// 		this.handleMouseOverColumnHeader =
	// 			this.handleMouseOverColumnHeader.bind(this);
	// 		this.handleMouseUpColumnHeader =
	// 			this.handleMouseUpColumnHeader.bind(this);

	// 		this.handleMouseDownRowHeader =
	// 			this.handleMouseDownRowHeader.bind(this);
	// 		this.handleMouseOverRowHeader =
	// 			this.handleMouseOverRowHeader.bind(this);
	// 		this.handleMouseUpRowHeader = this.handleMouseUpRowHeader.bind(this);
	...
	// 		// Keep listening to mouse if user releases the mouse (dragging outside)
	// 		document.addEventListener("mouseup", this.handleMouseUpRowHeader);
	// 		// Listen for any outside mouse clicks
	// 		document.addEventListener("mousedown", this.pageClick);
	...
	// 	handleMouseUpRowHeader() {
	// 		this._setState({ selectingRow: false });
	// 		document.removeEventListener("mouseup", this.handleMouseUpRowHeader);
	// 	}
